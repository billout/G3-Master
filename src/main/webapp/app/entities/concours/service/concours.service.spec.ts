  ...
  describe('Concours Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        ...
        code: 'AAAAAAA',
        libelle: 'AAAAAAA',
        dtOuverture: currentDate,
        dtCloture: currentDate,
      };
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            dtOuverture: currentDate.format(DATE_FORMAT),
            dtCloture: currentDate.format(DATE_FORMAT),
          },
          elemDefault
        );
      ...
      describe('addConcoursToCollectionIfMissing', () => {
        ...
        it('should add only unique Concours to an array', () => {
          const concoursArray: IConcours[] = [{ id: 123 }, { id: 456 }, { id: 97798 }];
