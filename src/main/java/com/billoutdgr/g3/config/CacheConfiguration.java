package com.billoutdgr.g3.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.billoutdgr.g3.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.billoutdgr.g3.repository.UserRepository.USERS_BY_EMAIL_CACHE);
