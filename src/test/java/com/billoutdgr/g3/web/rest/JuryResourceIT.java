...
class JuryResourceIT {
    ...
    void createJury() throws Exception {
        ...
        // Create the Jury
        restJuryMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(jury)))
    ...
    void putNewJury() throws Exception {
        ...
        restJuryMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedJury.getId())
    ...
    void putNonExistingJury() throws Exception {
        ...
        restJuryMockMvc
            .perform(
                put(ENTITY_API_URL_ID, jury.getId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void putWithMissingIdPathParamJury() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restJuryMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(jury)))
    ...
    void patchNonExistingJury() throws Exception {
        ...
        restJuryMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, jury.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(jury))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamJury() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restJuryMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(jury)))
            .andExpect(status().isMethodNotAllowed());
