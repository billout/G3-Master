...
class PersonnesResourceIT {
    ...
    void createPersonnes() throws Exception {
        ...
        restPersonnesMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(personnesDTO)))
    ...
    void putNewPersonnes() throws Exception {
        ...
        restPersonnesMockMvc
            .perform(
                put(ENTITY_API_URL_ID, personnesDTO.getId())
    ...
    void putWithMissingIdPathParamPersonnes() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restPersonnesMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(personnesDTO)))
    ...
    void patchNonExistingPersonnes() throws Exception {
        ...
        restPersonnesMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, personnesDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(personnesDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamPersonnes() throws Exception {
        ...
        restPersonnesMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(personnesDTO))
            )
            .andExpect(status().isMethodNotAllowed());
