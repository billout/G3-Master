...
class EpreuvesResourceIT {
    ...
    void createEpreuves() throws Exception {
        ...
        // Create the Epreuves
        restEpreuvesMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(epreuves)))
    ...
    void putNewEpreuves() throws Exception {
        ...
        restEpreuvesMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedEpreuves.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedEpreuves))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingEpreuves() throws Exception {
        ...
        restEpreuvesMockMvc
            .perform(
                put(ENTITY_API_URL_ID, epreuves.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(epreuves))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamEpreuves() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEpreuvesMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(epreuves)))
    ...
    void patchNonExistingEpreuves() throws Exception {
        ...
        restEpreuvesMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, epreuves.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(epreuves))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamEpreuves() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restEpreuvesMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(epreuves)))
            .andExpect(status().isMethodNotAllowed());
