...
class VoieAccesResourceIT {
    ...
    void createVoieAcces() throws Exception {
        ...
        restVoieAccesMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(voieAcces)))
    ...
    void putNewVoieAcces() throws Exception {
        ...
        restVoieAccesMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedVoieAcces.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedVoieAcces))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingVoieAcces() throws Exception {
        ...
        restVoieAccesMockMvc
            .perform(
                put(ENTITY_API_URL_ID, voieAcces.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(voieAcces))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamVoieAcces() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restVoieAccesMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(voieAcces)))
    ...
    void patchNonExistingVoieAcces() throws Exception {
        ...
        restVoieAccesMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, voieAcces.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(voieAcces))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamVoieAcces() throws Exception {
        ...
        restVoieAccesMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(voieAcces))
            )
            .andExpect(status().isMethodNotAllowed());
