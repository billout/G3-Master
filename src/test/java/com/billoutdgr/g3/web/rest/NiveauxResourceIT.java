...
class NiveauxResourceIT {
    ...
    void createNiveaux() throws Exception {
        ...
        // Create the Niveaux
        restNiveauxMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(niveaux)))
    ...
    void putNewNiveaux() throws Exception {
        ...
        restNiveauxMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedNiveaux.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedNiveaux))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingNiveaux() throws Exception {
        ...
        restNiveauxMockMvc
            .perform(
                put(ENTITY_API_URL_ID, niveaux.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(niveaux))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamNiveaux() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNiveauxMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(niveaux)))
    ...
    void patchNonExistingNiveaux() throws Exception {
        ...
        restNiveauxMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, niveaux.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(niveaux))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamNiveaux() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restNiveauxMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(niveaux)))
            .andExpect(status().isMethodNotAllowed());
