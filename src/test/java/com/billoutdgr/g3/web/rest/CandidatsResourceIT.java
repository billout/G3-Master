...
class CandidatsResourceIT {
    ...
    void createCandidats() throws Exception {
        ...
        restCandidatsMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(candidats)))
    ...
    void putNewCandidats() throws Exception {
        ...
        restCandidatsMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedCandidats.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(updatedCandidats))
            )
            .andExpect(status().isOk());
    ...
    void putNonExistingCandidats() throws Exception {
        ...
        restCandidatsMockMvc
            .perform(
                put(ENTITY_API_URL_ID, candidats.getId())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(candidats))
            )
            .andExpect(status().isBadRequest());
    ...
    void putWithMissingIdPathParamCandidats() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restCandidatsMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(candidats)))
    ...
    void patchNonExistingCandidats() throws Exception {
        ...
        restCandidatsMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, candidats.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(candidats))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamCandidats() throws Exception {
        ...
        restCandidatsMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(candidats))
            )
            .andExpect(status().isMethodNotAllowed());
